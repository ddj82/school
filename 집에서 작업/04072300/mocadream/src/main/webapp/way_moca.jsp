...
<div id="sub">
	...
	<div>
		...
		<p><b>무료 이용인 만큼 회원가입 후 이용 가능</b>하며 간단한 정리정돈을 셀프서비스로 대체하여 인건비를 줄이고 좀 더 나은 환경을 여러분께 제공해 드립니다.  </p>
		<p><img src="roompic/5.jpg" ></p>
	</div>
	...
	<div style="border-top:1px solid #767676">
		<h4>운영시간</h4>
		<ul>
	...
	<div><p style="color:red;"> &#9733; 예약 신청 후 미사용 시 경고 1회 처리됩니다. 3회 경고 시 제재 회원으로 이용이 불가합니다.</p>
	...
	<div style="margin-left: 90%;">
		<a href="roomListAction.mc" ><b>실시간 예약하기</b></a>
	</div>
