...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/locales/bootstrap-datepicker.ko.js" integrity="sha512-L4qpL1ZotXZLLe8Oo0ZyHrj/SweV7CieswUODAAPN/tnqN3PA1P+4qPu5vIryNor6HQ5o22NujIcAZIfyVXwbQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
...
<style>
  ...
  box-sizing: border-box;
  border: 1px solid #868e96; // 테두리 설정은 본인 맘대로
  position: relative; // 캘린더 아이콘을 클릭해야만 달력이 보이기 때문에 이 영역 자체를 제어하기 위해 설정  */
  width: 100%;
  padding: 10px;
/*   background: no-repeat right 10px center / 35px auto;  */
  border-radius: 8px;
  text-align: center;
  font-size: 100%;
  margin-bottom: 20px; 
...
<!-- /> -->
            ...
            <tr>
           	...
           	<script>
//            	window.onload = function(){
//            		document.querySelector("#r_cal").onclick = function(){
//            			console.log('style: ', document.querySelector('.input_date_box input').style);
//            		};
//            	};
           	</script>
            ...
            <tr>
               <td colspan="2">
               <input type="submit" id="order" value="예약 신청하기">&nbsp;&nbsp;
               <input type="reset" id="reset" value="다시 작성하기">
               </td>
            </tr>
         </table>
      </section>
