		...
		<section id="joinformArea">
			...
			<form action="myPageModifyProAction.mc" onsubmit="return validateForm()" method="post" name="modifyform">
				<table>
					...
					<section id="addr">
						<td><label for="newAddr">주소</label> <br>
						<tr>
							<td>
								<input type="text" class="addNum" name="addNum" id="sample6_postcode" style="width: 40%;" placeholder="우편번호" readonly />
							 	<input type="button" name="adrbtn" style="float:right;" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" />
							</td>
						</tr>
						<tr>
					...
					<tr>
						<td id="btns">
							<br><button id="registerBtn" class="btn1" type="submit">수정</button>
						</td>
					</tr>
				</table>
			</form><br>
			<table >
				<tr>
					<td style="text-align:center; font-weight: bold;font-size: 14px;"><a href="javascript:history.go(-1)">메인으로</a> | <a 
					style="font-weight: bold; font-size: 14px;" class="modal_btn" >회원탈퇴</a></td>
				</tr>
			</table><br>
	<div class="modal">
		<div class="modal_popup">
			<form action="memberDeleteAction.mc" method="POST">
				<fieldset>
					...
					<button type="submit" class="selectButton" style="color: white;">네</button>
					<button type="button" class="close_btn selectButton" style="width:auto; padding:5px; color: white;">아니요</button>
					</td>
					</tr>
				</table></fieldset>
			</form>
