...
<body>
	...
	<form action="08_05_02_form06_process.jsp" name="member" method="post">
		...
		<p>
			취미 : 
			<input type="checkbox" value="독서" name="hobby" id="hobby1" checked><label for="hobby1">독서</label>
			<input type="checkbox" value="운동" name="hobby" id="hobby2"><label for="hobby2">운동</label>
			<input type="checkbox" value="영화" name="hobby" id="hobby3"><label for="hobby3">영화</label>
		</p>
		<p>
