...
<body>
	...
	<section id="joinformArea">
		...
		<form action="myPageModifyProAction.mc" onsubmit="return validateForm()" method="post" name="modifyform">
			<table>
				...
				<tr>
					...
					<input name="email" type="text" class="email" pattern="[a-zA-Z0-9_]+[@][a-zA-Z]+[.][a-zA-Z]+[.]*[a-zA-Z]*" id="email" value="<%=mcuser.getEmail()%>"></td>
				</tr>
				<section>
		...
		<table>
			<tr>
				<td><a href="javascript:history.go(-1)">[취소]</a> <a href="deleteForm.mc">[회원탈퇴]</a></td>
			</tr>
		</table>
		...
		<script>
			function validateForm() {
				...
				if (address == "") {
					document.getElementById("postcodeerrorMessages").innerHTML = "●&nbsp 상세 주소를 입력해주세요.";
