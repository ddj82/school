...
public class MocaModifyProAction implements Action {
    ...
    public ActionForward execute(HttpServletRequest request, HttpServletResponse response) //7방 수정할 파라미터 뿐이야 request
            throws Exception {
        ActionForward forward = null;
        Mc_rooms room = null;
        String realFolder = "";
...
//        System.out.println("request: "+request.getParameter("R_NO"));
		...
		System.out.println("업데이트가 됐으면 isModifySuccess=> true받음 : " + isModifySuccess);
...
//            forward.setPath("mocaList.mc?r_no=" + room.getR_no() + "&page=" + request.getParameter("page"));
