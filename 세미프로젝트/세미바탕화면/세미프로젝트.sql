...
--R_NO NUMBER(1),
--R_RNAME VARCHAR2(30) NOT NULL UNIQUE,
...
--R_STATIME NUMBER(2),
--R_ENDTIME NUMBER(2),
--R_OK VARCHAR2(10) DEFAULT '가능' CHECK(R_OK IN('가능', '불가능')) NOT NULL,
--R_USED VARCHAR2(10),
--R_FILE VARCHAR2(50)
--);

DROP TABLE MC_ROOMS PURGE;
...
R_BNM VARCHAR2(20),
R_BCAL DATE,
R_BTIME NUMBER(1) CHECK(R_BTIME IN(1, 2, 3)),
R_BSTATIME NUMBER(2),
R_BENDTIME NUMBER(2),
R_USED VARCHAR2(10)
);
