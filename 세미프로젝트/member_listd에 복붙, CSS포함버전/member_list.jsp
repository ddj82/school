				...
				<tr>
					...
					<td>
						<button class="button-link"
							onclick="location.href='memberWarningAction.mc?id=<%=articleList.get(i).getId()%>'">경고주기</button>
					</td>
					<%
					} else {
					%>
					...
					<td>
						<button class="button-link"
							onclick="location.href='memberReleaseAction.mc?id=<%=articleList.get(i).getId()%>'">정지해제</button>
					</td>
					<%
					} else {
					%>
