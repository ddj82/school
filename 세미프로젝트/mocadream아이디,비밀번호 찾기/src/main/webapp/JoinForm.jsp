...
<body>
	<section id="joinformArea">
		<form name="joinform" action="./memberJoinAction.mc" method="post" onsubmit="return validateForm()" >
			<table>
				<tr>
					<td colspan="2">
						<h1>회원가입 페이지</h1>
					...
					<td><label for="id">아이디 </label><br>
						<div id="idbox">
							<input type="text" name="id" id="id" pattern="[a-zA-Z0-9]+"
								minlength="6" maxlength="20" placeholder="아이디" />
				...
				<tr>
					...
					<input type="password" name="pw" id="pw"
						pattern="[a-zA-Z0-9!_\-!@#$%^&*]+" minlength="8" maxlength="15"
						placeholder="비밀번호" /></td>
				</tr>
				<tr>
					<td><label for="pwcf">비밀번호 확인 </label><br>
					<input type="password" name="pwcf" id="pwcf"
						pattern="[a-zA-Z0-9!_\-!@#$%^&*]+" minlength="8" maxlength="15"
				...
				<tr>
					...
					<input type="text" name="name" id="name" pattern="[가-힣a-zA-Z\s]+"
						placeholder="이름" maxlength="6" /></td>
				</tr>
				<tr>
					<td><label for="tel">전화번호 </label><br>
					<input type="text" name="tel" id="tel"
						placeholder="휴대전화번호 예시 : 000-0000-0000"
						pattern="(010)-[0-9]{4}-[0-9]{4}" /></td>
				</tr>
				<tr>
					<td><label for="email">이메일 주소 </label><br>
					<input type="text" name="email" id="email"
						pattern="[a-zA-Z0-9_]+[@][a-zA-Z]+[.][a-zA-Z]+[.]*[a-zA-Z]*"
						placeholder="이메일" maxlength="100" /></td>
				</tr>
				...
				<section id="addr">
					<td><b>주소</b></td>
					<tr>
						<td><input type="button" name="adrbtn"
							onclick="sample6_execDaumPostcode()" value="우편번호 찾기" /><br>
						<input type="text" name="addNum" id="sample6_postcode"
							placeholder="우편번호" readonly /></td>
					</tr>
					<tr>
						<td><label for="addr1"></label><input type="text"
							name="addr1" id="sample6_address" placeholder="주소" 	readonly /></td>
					</tr>
					<tr>
					...
					<tr>
						<td><input type="text" name="cmt" id="sample6_extraAddress"
				...
				<tr>
					<td id="btns">
						<button id="registerBtn" class="btn1" type="submit" >
							회원가입</button>&nbsp;&nbsp;
					</td>
				</tr>
			</table>
