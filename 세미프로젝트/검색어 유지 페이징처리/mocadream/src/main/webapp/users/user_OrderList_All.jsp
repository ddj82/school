...
<body style="background-color: rgb(250, 240, 230)">
	<div
			...
			<section id="ListArea">
				<table>
					...
					<tr>
						...
						%>
						<td><a class="button" href="orderDelete.mc?r_no=<%=mc_OrderList.get(i).getR_no()%>&r_cal=<%=orderD2%>&r_statime=<%=mc_OrderList.get(i).getR_statime()%>">취소</a>
						</td>
						<%
						}
						%>
		...
		<section style="text-align: center;">
			...
			%>
			<a href="userorder_list.mc?page=<%=a%>">[<%=a%>]
			</a>&nbsp;
			<%
			}
			%>
